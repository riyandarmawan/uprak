<div class="flex min-h-full flex-col justify-center px-6 lg:px-8 mb-10">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Tambah Siswa</h2>
    </div>

    <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="/siswa/tambah" method="POST">
            <div>
                <label for="nis" class="block text-sm font-medium leading-6 text-gray-900">NIS</label>
                <div class="mt-2">
                    <input id="nis" name="nis" type="number" required placeholder="22001001" autocomplete="nis" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 <?= isset($_SESSION['flash']['nis']) ? 'invalid' : 'valid' ?>">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="namaLengkap" name="namaLengkap" type="text" required placeholder="Riyan Darmawan" autocomplete="namaLengkap" value="<?= Flasher::getOld('namaLengkap') ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 <?= isset($_SESSION['flash']['namaLengkap']) ? 'invalid' : 'valid' ?>">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="tanggalLahir" name="tanggalLahir" type="date" required autocomplete="tanggalLahir" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 <?= isset($_SESSION['flash']['tanggalLahir']) ? 'invalid' : 'valid' ?>">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="noHp" name="noHp" type="number" required placeholder="0898291829" autocomplete="noHp" value="<?= Flasher::getOld('noHp') ?>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 <?= isset($_SESSION['flash']['noHp']) ? 'invalid' : 'valid' ?>">
